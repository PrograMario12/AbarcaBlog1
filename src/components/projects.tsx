            ...
            >
              <CardHeader>
                <div className="flex justify-between items-start">
                  ...
                  {project.real === false && (
                    <Bird className="h-6 w-6 text-[#FFD23F]" />
                  )}
                </div>
              ...
              <CardFooter className="flex gap-4">
                <Link
                  href={project.github}
                  className="inline-flex items-center text-sm font-medium hover:text-blue-400 transition-colors"
                >
                  <Github className="mr-2 h-4 w-4" />
                  Code
                </Link>
                {project.real !== false && project.live && (
                  <Link
                    href={project.live}
                    className="inline-flex items-center text-sm font-medium hover:text-blue-400 transition-colors"
                  >
